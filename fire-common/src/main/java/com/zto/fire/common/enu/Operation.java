...
public enum Operation {
    ...
    REPLACE_TABLE(8), REPLACE_TABLE_AS_SELECT(9), ALTER_TABLE_RENAME_PARTITION_OLD(10), ALTER_TABLE_RENAME_PARTITION_NEW(11),
    ALTER_TABLE_DROP_PARTITION(12), TRUNCATE(13), CACHE(14), UNCACHE(15), REFRESH(16), CREATE_DATABASE(17), DROP_DATABASE(18),
    ALTER_TABLE_ADD_PARTITION(19), ALTER_TABLE(20), INSERT_INTO(21), INSERT_OVERWRITE(22), UNKNOWN(404);
