 ...
 */
public class RocketMQSinkWithTag<IN> extends RichSinkFunction<IN> implements CheckpointedFunction {
    ...
    public RocketMQSinkWithTag(JsonSerializationSchema schema, TopicSelector<IN> topicSelector, Properties props) {
    ...
    private Message prepareMessage(IN input) {
        ...
        Message msg = serializationSchema.serialize(rowData);
    ...
    public RocketMQSinkWithTag<IN> withAsync(boolean async) {
        this.async = async;
        return this;
    }

    public RocketMQSinkWithTag<IN> withBatchFlushOnCheckpoint(boolean batchFlushOnCheckpoint) {
        this.batchFlushOnCheckpoint = batchFlushOnCheckpoint;
        return this;
    }

    public RocketMQSinkWithTag<IN> withBatchSize(int batchSize) {
